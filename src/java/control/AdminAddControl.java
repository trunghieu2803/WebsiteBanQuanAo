    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (btnThem) {
            case "btnSanPham":
                ...
                response.sendRedirect("/WebsiteBanQuanAo/ashowcontrol?btnname=btnsanpham");
                break;
            case "danhmucsanpham":
                ...
                response.sendRedirect("/WebsiteBanQuanAo/ashowcontrol?btnname=danhmucsanpham");
                break;
            case "btnAccount":
                ...
                response.sendRedirect("/WebsiteBanQuanAo/ashowcontrol?btnname=account");
                break;
            case "btnDonHang":
                ...
                if(dtrangThai != null)
                    response.sendRedirect("/WebsiteBanQuanAo/ashowcontrol?btnname=donhang");
                break;
            default:
